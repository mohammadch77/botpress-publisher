...
return new class extends Migration
{
    ...
    {
        Schema::create('bale_destinations', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('tenant_id', 'idx_bale_dest_tenant');
            $table->index('bot_id', 'idx_bale_dest_bot');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('bale_destinations');
    }
};
