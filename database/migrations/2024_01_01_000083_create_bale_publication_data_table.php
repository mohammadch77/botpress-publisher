...
return new class extends Migration
{
    ...
    {
        Schema::create('bale_publication_data', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('parse_mode', ['HTML', 'Markdown'])->nullable()->default('HTML');
            ...
            $table->index('tenant_id', 'idx_baled_tenant');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('bale_publication_data');
    }
};
